...
#define THREAD_STACK_SIZE 46 * 1024
...
//每個 process/thread 都應該有自己獨立的 open file descriptor 表
#define MAX_FD 16
...
int thread_exec_user_function(void (*func)());          // execute build in function call
