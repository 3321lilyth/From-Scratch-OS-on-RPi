...
#define PM_RSTC PA_TO_VA_KERNEL(0x3F10001c)		//網站上是 #define ARM_PM_RSTC		(ARM_PM_BASE + 0x1C)
#define PM_WDOG PA_TO_VA_KERNEL(0x3F100024)		//網站上是 #define ARM_PM_WDOG		(ARM_PM_BASE + 0x24)
