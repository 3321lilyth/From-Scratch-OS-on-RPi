...
#define CORE0_INTERRUPT_SOURCE      ((volatile unsigned int *)(PA_TO_VA_KERNEL(0x40000060)))
#define CORE0_TIMER_IRQ_CTRL        ((volatile unsigned int *)(PA_TO_VA_KERNEL(0x40000040)))
